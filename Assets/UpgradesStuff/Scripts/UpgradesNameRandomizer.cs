...
public static class UpgradesNameRandomizer
{
    ...
    private static Dictionary<StatsTypes, StringMultiple> itemNames = new()
    {
        ...
        {StatsTypes.CollectingRange, new StringMultiple("Tool Handle", "Metal Detector") },
        {StatsTypes.CollectingDamage, new StringMultiple("Tool Reinforcement") },
        {StatsTypes.InteractCooldown, new StringMultiple("Goggles") },
        {StatsTypes.MaxResourceInteractions, new StringMultiple("Tool belt") },
    ...
    private static Dictionary<StatsTypes, StringMultiple> itemAdjectives = new()
    {
        ...
        {StatsTypes.CollectingRange, new StringMultiple("Farmlike", "Fresh") },
        {StatsTypes.CollectingDamage, new StringMultiple("Rustic", "Mechanized") },
        {StatsTypes.InteractCooldown, new StringMultiple("Rural") },
        {StatsTypes.MaxResourceInteractions, new StringMultiple("Little", "Farmish") },
    ...
    private static Dictionary<StatsTypes, StringMultiple> thirdItemName = new()
    {
        ...
        {StatsTypes.CollectingRange, new StringMultiple("from the farmer", "of the farm") },
        {StatsTypes.CollectingDamage, new StringMultiple("with farmer's strength", "from the countryside") },
        {StatsTypes.InteractCooldown, new StringMultiple("for work", "from a farm") },
        {StatsTypes.MaxResourceInteractions, new StringMultiple("with extra tools", "with extra tools") },
    ...
    private static Dictionary<StatsTypes, StringMultiple> fourthItemName = new()
    {
        ...
        {StatsTypes.CollectingRange, new StringMultiple(", found in a barn") },
        {StatsTypes.CollectingDamage, new StringMultiple("from the cowhouse") },
        {StatsTypes.InteractCooldown, new StringMultiple("crafted by a shepherd") },
        {StatsTypes.MaxResourceInteractions, new StringMultiple("with wool thread") },
