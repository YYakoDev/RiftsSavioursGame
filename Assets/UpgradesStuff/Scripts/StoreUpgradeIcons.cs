...
public static class StoreUpgradeIcons
{
    ...
    static void LoadResources()
    {
        ...
        _storeUpgradesIcons = new()
        {
            ...
            {StatsTypes.CollectingRange, toolIcon},
            {StatsTypes.CollectingDamage, toolIcon},
            {StatsTypes.InteractCooldown, toolIcon},
            {StatsTypes.MaxResourceInteractions, toolIcon},
