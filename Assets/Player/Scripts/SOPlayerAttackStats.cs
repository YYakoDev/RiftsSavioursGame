...
public class SOPlayerAttackStats : PlayerStatsBase
{
    ...
    [SerializeField] private float _baseDamageAddition = 0;
    [SerializeField]private float _attackRange, _attackCooldown = 1, _attackSpeed = 1;
    [SerializeField, Range(0f , 2.25f)]private float _attackKnockback = 1;
    [SerializeField]private float _projectilesCount = 1;
    [SerializeField]private float _projectilesSpeed = 1;
    [SerializeField] private float _summonDamage = 5;
